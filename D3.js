...
for (let i = 0; i < starWarsCharacters.length; i++) if (starWarsCharacters[i].gender === "female") femaleCharacters.push(starWarsCharacters[i]);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log("Questo colore non puo essere smistato!");
  }
}
...
else if (crewMass > 500 && crewMass < 700) stampa = "Ship is half loaded";
else if (crewMass > 700 && crewMass < 900) stampa = "Warning: Load is over 700";
else if (crewMass > 900 && crewMass < 1000) stampa = "Critical Load: Over 900";
else {
